<div class="d-flex justify-content-between mb-3">
    ...
    <a href="<?= BASE_URL ?>/empresa" class="btn btn-secondary">
...
<div class="row">
    <div class="col-md-8">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="<?= BASE_URL ?>/empresa/update" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">El nombre no se puede editar desde aqui.</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php endif; ?>
                        <small class="text-muted">Formatos: JPG, PNG, GIF, WebP. Tamano recomendado: 200x200px</small>
                    </div>
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            <div class="card-header bg-info text-white">
                <h5 class="mb-0"><i class="bi bi-info-circle"></i> Informacion</h5>
            </div>
            <div class="card-body">
                ...
                <?php if (!empty($empresaConfig['logo_file'])): ?>
                    <hr>
                    <p><strong>Logo Actual:</strong></p>
                    <img src="<?= empresaUploadUrl('img_config') ?>/<?= htmlspecialchars($empresaConfig['logo_file']) ?>"
