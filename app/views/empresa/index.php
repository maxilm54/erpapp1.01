<div class="d-flex justify-content-between mb-3">
    ...
    <div>
        <a href="<?= BASE_URL ?>/empresa/edit" class="btn btn-warning">
            <i class="bi bi-pencil"></i> Editar Empresa
        </a>
        <a href="<?= BASE_URL ?>/empresa/users" class="btn btn-info">
    ...
    <div class="col-md-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <a href="<?= BASE_URL ?>/empresa/create-user" class="btn btn-sm btn-outline-success mt-2">
