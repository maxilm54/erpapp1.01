...
INSERT INTO act_bd (id,descripcion) VALUES (7,'DISCONTINUADO, ya sale con el squema. Agregar precio_unitario a remitos_salida_detalle Permite guardar el precio unitario personalizado por producto en cada remito');
