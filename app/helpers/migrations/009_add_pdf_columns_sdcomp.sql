-- =====================================================
-- Migration 009: Agregar columnas pdf_path y pdf_hash a movimientos_no_declarados
...
INSERT INTO act_bd (id, descripcion) VALUES (9, 'Agregar columnas pdf_path y pdf_hash a movimientos_no_declarados para almacenar PDFs');
-- =====================================================